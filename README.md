...
Dự đoán nguy cơ tiểu đường dựa trên thuật toán Học máy (KNN & Logistic Regression)
  ...
  Giới thiệu Đồ án
Dự án tập trung vào việc xây dựng một hệ thống sàng lọc sớm bệnh tiểu đường dựa trên bộ dữ liệu Pima Indians Diabetes. Hệ thống cho phép người dùng nhập các chỉ số sinh học cơ bản và nhận kết quả cảnh báo ngay lập tức.
